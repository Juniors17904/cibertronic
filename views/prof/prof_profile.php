                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-9">
                                ...
                                <form>
                                    <div class="row gx-5 gy-4"> <!-- g-4 da espacio horizontal y vertical entre columnas -->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="<?= htmlspecialchars($prof['dni']) ?>" readonly>
                                        </div>
