            ...
            <div class="dropdown d-flex align-items-center ms-3">
                ...
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                    <div class="position-relative me-2">
                        <img src="<?= BASE_URL ?>/assets/images/<?= htmlspecialchars(!empty(trim($admin['foto'])) ? $admin['foto'] : 'perfil.jpg') ?>" alt="Perfil" width="36" height="36" class="rounded-circle border border-2 border-primary">
