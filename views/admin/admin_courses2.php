...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        console.log('AREA:', areaId, 'CURSO:', cursoId, 'HORARIO:', horarioId);

        if (typeof areaId !== 'undefined' && areaId && cursoId && horarioId) {
            ...
            // Simula cambio de Área y espera a que carguen los cursos
            modalArea.dispatchEvent(new Event('change'));

            // Espera a que cursos se carguen
            modalArea.addEventListener('change', () => {
                fetch(`../../controllers/get_cursos_por_area.php?area_id=${areaId}`)
                    ...
                    .then(cursos => {
                        ...
                        cursos.forEach(curso => {
                            ...
                            modalCurso.appendChild(opt);
                        });
                        modalCurso.disabled = false;

                        // Marca curso
                        modalCurso.value = cursoId;
                        modalCurso.dispatchEvent(new Event('change'));

                        // Ahora carga horarios
