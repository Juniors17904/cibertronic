            ...
            <main class="col-md-8 col-lg-9 px-2 px-md-5 py-4">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <a href="admin_detalles_asistencias.php?asignacion_id=<?= urlencode($asig['codigo_asignacion'])     ?>&profesor_id=<?= urlencode($asig['id_usuario_profesor']) ?>" class="btn btn-info mt-3 ms-2">
                            <i class="fas fa-calendar-check"></i> Ver Detalles Asistencia
                        </a> -->


                        <a href="admin_detalles_asistencias.php?asignacion_id=<?= urlencode($asig['codigo_asignacion']) ?>&profesor_id=<?= urlencode($asig['id_usuario_profesor']) ?>&id_asig=<?= urlencode($asig['id']) ?>"
                        ...
                        <a href="admin_detalles_notas.php?asignacion_id=<?= urlencode($asig['codigo_asignacion'])     ?>&profesor_id=<?= urlencode($asig['id_usuario_profesor']) ?>&id_asig=<?= urlencode($asig['id']) ?>"
